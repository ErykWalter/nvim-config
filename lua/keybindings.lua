...
-- Neo Tree {{{
nm('<leader>e', '<cmd>Neotree position=left<CR>')                 -- Toggle file explorer
nm('<leader>eb', '<cmd>Neotree position=left source=buffers<CR>') -- Toggle file explorer
-- }}}

nm('<leader><CR>', '<cmd>ToggleTerm<CR>')
tm('<Esc>', '<C-\\><C-n>')
